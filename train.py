...
window.title("Person Tracking System")
...
message = tk.Label(window, text="Face-Recognition-Based-Person-Tracking-System" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline'))
...
lbl3 = tk.Label(window, text="Message: ",width=20  ,fg="red"  ,bg="yellow"  ,height=2 ,font=('times', 15, ' bold  underline'))
